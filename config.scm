...
(define selbordercolor   "#005577")
(define selbgcolor       "#005577")
(define selfgcolor       "#eeeeee")
(define borderpx         1)   ; border pixel of windows
(define snap             32)  ; snap pixel
(define showbar          #t)  ; False means no bar
(define topbar           #t)  ; False means bottom bar
...
(define resizehints      #t)  ; True means respect size hints in tiled resizals */

(define layouts (list
				  (make-Layout "[]=" tile)  ; first entry is default
				  (make-Layout "><>" #f)    ; no layout function means floating behavior
				  (make-Layout "[M]" monocle)))
...
(define *disp-string* "herping the derp")
