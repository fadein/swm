...
(define-syntax BUTTONMASK
  (syntax-rules () ((_) (bitwise-ior BUTTONPRESSMASK BUTTONRELEASEMASK))))
;  #define CLEANMASK(mask)         (mask & ~(numlockmask|LockMask) & (ShiftMask|ControlMask|Mod1Mask|Mod2Mask|Mod3Mask|Mod4Mask|Mod5Mask))
(define-syntax INTERSECT
  (syntax-rules ()
				((_ x y w h m)
				 (* (max 0 (- (min (+ x w) (+ (Monitor-wx m) (Monitor-ww m)))
							  (max x (Monitor-wx m))))
...
;  /* Xlib egg is missing XSetErrorHandler() */
;  void
;  checkotherwm(void) {
...
;  /* Xlib egg is missing all XINERAMA stuff */
;  #ifdef XINERAMA
